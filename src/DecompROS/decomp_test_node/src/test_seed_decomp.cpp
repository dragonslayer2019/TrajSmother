...
int main(int argc, char ** argv){
  ...
  std::cout << "Time taken by code: " << duration.count() << " milliseconds, code's frequency is: " << int(1000.0 / duration.count()) << std::endl;
  // ROS_INFO("Time taken by code:%f ,milliseconds, code's frequency is: %d", duration.count(), int(1000.0 / duration.count()));
